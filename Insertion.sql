...
INSERT INTO Staff.Customers (CustomerID, CustomerName, ContactNumber, Email, Address)
VALUES
...
INSERT INTO Staff.Orders (OrderID, CustomerID, OrderDate, TotalAmount)
VALUES
...
INSERT INTO Staff.Products (ProductID, ProductName, Category, Price, StockQuantity)
VALUES
...
INSERT INTO Staff.OrderDetails (OrderDetailID, OrderID, ProductID, Quantity, UnitPrice)
VALUES
    (1, 1, 1, 3, 1200.00),
    (2, 1, 2, 2, 400.00),
    (3, 2, 4, 4, 800.00),
